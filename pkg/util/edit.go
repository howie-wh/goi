...
// An edits are a list of edits that is sortable by start offset, breaking ties by end offset.
type edits []edit
...
func (b *Buffer) Bytes() []byte {
	...
	for i, e := range b.q {
		...
		dataBuff = append(dataBuff, b.old[offset:e.start]...)
		offset = e.end
		dataBuff = append(dataBuff, e.new...)
	}
	dataBuff = append(dataBuff, b.old[offset:]...)
	return dataBuff
}
